...
1. As-is
2. Hit the Preview button (<img src="./includes/preview.png" height="15">) in the menu to render the discussion into a HTML document. (This is the pretty option.)
...
- Remember, you MUST run this code chunk once per session.
...
- Data Viz Tips: [https://www.data-to-viz.com/](https://www.data-to-viz.com/)
